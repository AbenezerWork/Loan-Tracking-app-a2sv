...
type RefreshTokenController struct {
	...
	jwtsrv              utils.JWTService
}

func NewRefreshTokenController(uu domain.UserUsecaseInterface, rt domain.RefreshTokenUsecaseInterface, js utils.JWTService) *RefreshTokenController {
